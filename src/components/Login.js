...
const Login = () => {
  ...
  return (
    <div className="main">
      ...
      <form action="" className="form_main" onSubmit={handleSubmit}>
        ...
        <button id="button" type="submit" >Dăng nhập</button>
        <p class="forgotLink" onClick={handleRegister}>Bạn chưa có tài khoản?</p>
      </form>
    </div>
  );
  ...
  //       <div className="login">
  //         <form className="form">
  //           <label id="chk" aria-hidden="true">Log in</label>
  ...
  // 			<form className="form">
  // 				<label id="chk" aria-hidden="fasle">Register</label>
